...
i18n.localize = function(app, options) {
    ...
    o.availableLocales.forEach(function (locale) {
        if (!i18n.plurals.isSupported(locale.split('-')[0])) {
            throw new Error('unsupported language set as available: ' + locale);
        }
    });
    ...
    function middleware(req, res, next) {
        ...
        if (!locale) {
            locale = model.get('_page._i18n.locale');
        }
        ...
        // Thunberbirds are go.
        model.set('_page._i18n.locale', locale);
        model.set('_page._i18n.language', language);
        model.set('_page._i18n.region', region);
        model.set('_page._i18n.namespace', o.ns);
    ...
    function _translate(key) {
        ...
        return o.backend.get(model, model.get('_page._i18n.locale'), model.get('_page._i18n.namespace'), key);
    }
    function _locale() {
        return this.view.model.get('_page._i18n.locale');
    }
    function _language() {
        return this.view.model.get('_page._i18n.language');
    }
    function _region() {
        return this.view.model.get('_page._i18n.region');
    }
    function _localizedPath(path) {
        return o.urlScheme == 'path' ? '/'+this.view.model.get('_page._i18n.locale')+'/'+path : path;
    }
